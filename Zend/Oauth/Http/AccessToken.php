...
class Zend_Oauth_Http_AccessToken extends Zend_Oauth_Http
{
     ...
     */
    public function execute($stringToken = null)
    {
        $params   = $this->assembleParams($stringToken);
     ...
     * @return array
     */
    public function assembleParams($stringToken)
    {
        $params = array(
        ...
        if($stringToken)
        {
            $params['oauth_token']  = $stringToken;
        }
        else
        {
        ...
        $params['oauth_signature'] = $this->_httpUtility->sign(
            ...
            $stringToken? '': $this->_consumer->getLastRequestToken()->getTokenSecret(),
